    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          {/* sidebar header */}
          <div className="p-4 pb-[27px] border-b border-pink-200 flex justify-around items-center">
...
const NoMatchesFound = () => (
  // it should ( ) and not { } if you are using curly brace return the component
...
const LoadingState = () => (
  <div className="flex flex-col items-center justify-center h-full text-center">
    ...
    <p className="text-gray-500 max-w-xs">
      We&apos;re finding your perfect matches. This might take moment...
    </p>
  </div>
);
